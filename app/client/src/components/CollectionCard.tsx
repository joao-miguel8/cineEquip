...
function CollectionCard({ cardInfo }) {
	...
	return (
		<div className="px-4 p-2 w-60 h-fit rounded-md overflow-hidden  shadow-[rgba(50,_50,_105,_0.15)_0px_2px_5px_0px,_rgba(0,_0,_0,_0.05)_0px_1px_1px_0px] bg-white hover:bg-yellow-200 transition duration-500 cursor-pointer">
